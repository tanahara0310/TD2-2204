...
void SkeletonModelObject::Initialize() {
   ...
   animInfo.directory = "Resources/SampleResources/simpleSkin";
   ...
   model_ = modelManager->CreateSkeletonModel(
	  "Resources/SampleResources/simpleSkin/simpleSkin.gltf",
...
void SkeletonModelObject::DrawDebug(std::vector<LineRenderer::Line>& outLines) {
...
bool SkeletonModelObject::DrawImGui() {
   bool changed = false;
