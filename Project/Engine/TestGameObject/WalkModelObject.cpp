...
void WalkModelObject::Initialize(EngineSystem* engine) {
	engine_ = engine;
	...
	model_ = modelManager->CreateSkeletonModel(
		"Resources/SampleResources/human/walk.gltf",
...
void WalkModelObject::DrawDebug(std::vector<LineRenderer::Line>& outLines) {
...
bool WalkModelObject::DrawImGui() {
	bool changed = false;
