...
void SkyBoxObject::Initialize(EngineSystem* engine) {
	...
	texture_ = TextureManager::GetInstance().Load("Resources/SampleResources/SkyBox/rostock_laage_airport_4k.dds");
}
