...
void SkyBoxRenderer::Initialize(ID3D12Device* device) {
    ...
    auto vertexShaderBlob = shaderCompiler_->CompileShader(L"Resources/Shader/Skybox/Skybox.VS.hlsl", L"vs_6_0");
    assert(vertexShaderBlob != nullptr);
    
    auto pixelShaderBlob = shaderCompiler_->CompileShader(L"Resources/Shader/Skybox/Skybox.PS.hlsl", L"ps_6_0");
