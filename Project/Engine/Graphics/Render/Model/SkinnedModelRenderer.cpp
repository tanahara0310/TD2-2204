...
void SkinnedModelRenderer::Initialize(ID3D12Device* device) {
    ...
    // シェーダーのコンパイルとPSO作成
    auto skinningVertexShaderBlob = shaderCompiler_->CompileShader(L"Resources/Shader/Skinning/SkinningObject3d.VS.hlsl", L"vs_6_0");
    assert(skinningVertexShaderBlob != nullptr);
    
    auto pixelShaderBlob = shaderCompiler_->CompileShader(L"Resources/Shader/Object/Object3d.PS.hlsl", L"ps_6_0");
