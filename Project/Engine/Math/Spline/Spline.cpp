...
std::vector<LineRenderer::Line> Spline::GenerateLines(int segments, const Vector3& color, float alpha) const
{
...
std::vector<LineRenderer::Line> Spline::GenerateControlPointLines(const Vector3& color, float alpha) const
{
    std::vector<LineRenderer::Line> lines;
