...
public:
   ...
   void StartShake(ShakeIntensity intensity, bool usePostEffect = false);
   ...
   void SetPostEffectCallback(const std::function<void(bool)>& callback) {
	  postEffectCallback_ = callback;
   }
...
private:
   ...
   std::function<void(bool)> postEffectCallback_;
