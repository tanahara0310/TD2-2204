...
void CameraController::StartShake(ShakeIntensity intensity, bool usePostEffect)
{
   if (usePostEffect) {
	  if (postEffectCallback_) {
		 postEffectCallback_(true);
	  }
   }
